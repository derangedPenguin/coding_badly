...
class PhysicsEntity:
    ...
    def render(self, surf, cam_offset=(0,0)):
        surf.blit(pygame.transform.flip(self.animation.img(), self.flip, False), (self.pos[0] - cam_offset[0] + self.anim_offset[0], self.pos[1] - cam_offset[1] + self.anim_offset[1]))
...
class Enemy(PhysicsEntity):
    ...
    def render(self, surf, cam_offset=(0,0)):
        ...
        if self.flip:
            surf.blit(pygame.transform.flip(self.game.assets['gun'], True, False), (self.rect().centerx - 4 - self.game.assets['gun'].get_width() - cam_offset[0], self.rect().centery - cam_offset[1]))
        else:
            surf.blit(self.game.assets['gun'], (self.rect().centerx + 4 - cam_offset[0], self.rect().centery - cam_offset[1]))

class Player(PhysicsEntity):
    def __init__(self, game, pos, size) -> None:
        super().__init__(game, 'player', pos, size)
        self.air_time = 0
        self.jumps = BASE_JUMPS
